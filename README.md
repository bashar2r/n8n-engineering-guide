...
- **Environment Discipline** — Pin Data, static data, environment variables, and safe dev/staging/production practice
...
- **Operate safely** — use Pin Data, static data, and environment discipline to prevent accidental damage to real client infrastructure
...
| 12 | Environment Discipline | Ready |
| 13 | Next Topic | Coming |
